...
Draftline embeds these fonts into generated PDFs so exported typography is
identical on Windows, macOS, and Linux and does not depend on fonts installed on
the author's computer.

- Merriweather Regular, Bold, Italic, and Bold Italic are from
  `SorkinType/Merriweather` revision

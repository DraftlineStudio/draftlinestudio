...
func TestDevelopmentsGiveARecognizableAccount(t *testing.T) {
	book := frameBook([]types.EvidenceRecord{
		...
		evidence("e5", 3, "Mira Brannick was killed in the warehouse fire.", "event", "state", "killed"),
...
func TestConflictingRetellingSurfaces(t *testing.T) {
	book := frameBook([]types.EvidenceRecord{
		evidence("e1", 0, `"Mira Brannick died on the bridge," Avery said.`, "event", "interaction", "said"),
		evidence("e2", 4, "Mira Brannick was killed in the warehouse fire.", "event", "state", "killed"),
	})

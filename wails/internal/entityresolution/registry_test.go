...
func TestResolveEntities_DoesNotBridgePeopleThroughSharedCommonToken(t *testing.T) {
	mentions := []Mention{
		{ID: "m1", Text: "Ilvane", Chapter: 0, CharOffset: 10},
		{ID: "m2", Text: "Could Ilvane", Chapter: 0, CharOffset: 30},
		{ID: "m3", Text: "Adaeze", Chapter: 0, CharOffset: 60},
		{ID: "m4", Text: "Could Adaeze", Chapter: 0, CharOffset: 90},
		{ID: "m5", Text: "That Could Not Be Counted", Chapter: 1, CharOffset: 10},
	}
	...
	for _, entity := range result.Entities {
		...
		if strings.Contains(aliases, "ilvane") && strings.Contains(aliases, "adaeze") {
			t.Fatalf("Ilvane and Adaeze were transitively merged: %+v", entity)
		}
	}
}

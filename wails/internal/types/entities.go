...
type AnalysisData struct {
	...
	// Story stores fast local structural and pacing measurements generated by
	// the bundled Prose analyzer. It is rebuildable and never overwrites the
	// author's story bible, beat sheet, or timeline.
	Story *StoryAnalysisData `json:"story,omitempty"`

	// Evidence stores source-located candidate facts and events generated by
	// deterministic local analysis. It is rebuildable and persisted so search,

...
describe('attributeSpeakers', () => {
  ...
  it('uses a standalone pronoun tag between two quotes for both spans', () => {
    const input = paragraphs(
      ...
      '“Technician Vale.” She said sharply. “The parts are ready.”',
    )
    const result = attributeSpeakers(input, ROSTER)
  ...
  it('tracks a synthetic workshop exchange across tags and action beats', () => {
    const engineer = speakerKeyFor('Elias Vale')
    const roster: RosterEntry[] = [
      { key: engineer, name: 'Elias Vale', aliases: ['Elias Vale', 'Vale', 'Technician Vale', 'Engineer Vale'] },
      ...ROSTER.slice(0, 1),
    ]
    const input = paragraphs(
      'Vale waited beside the supply cabinet.',
      'He inspected a stack of inventory sheets.',
      'Renee Alvarez arrived carrying a toolbox.',
      'Her boots squeaked on the clean floor.',
      '“Technician Vale.” She said sharply. “The parts are ready.”',
      'The morning delivery had arrived early.',
      '“Engineer,” he said.',
      'Alvarez lifted her pencil. “Pardon?”',
      '“Engineer Vale. The paperwork still says Engineer.”',
      'She checked the roster. “Right. Welcome aboard, Engineer.”',
    )
    ...
    expect(dialogue).toEqual([RENEE, RENEE, engineer, RENEE, engineer, engineer, RENEE, RENEE])
  })

...
"Open with" for `.epub`/`.docx` (routed to the importers). `.storiverse` and
`.pdf` are deliberately unregistered: universes can't be opened yet, and
there is no PDF importer.
